...
class BalanceUtilsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.alice_validator.with_command(f'--chain rococo-local --validator --insecure-validator-i-know-what-i-do --alice {RPC_DEV_FLAGS}')
        ...
        self.bob_validator.with_command(f'--chain rococo-local --validator --insecure-validator-i-know-what-i-do --bob {RPC_DEV_FLAGS}')
