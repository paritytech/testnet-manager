...
class NodeUtilsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.polkadot.with_command(f'--dev --validator --insecure-validator-i-know-what-i-do --node-key 4b067400ba508d783ccf86b73aa825ebafea96c95ebdff3f307ab6dd854f0852 {RPC_DEV_FLAGS}')
