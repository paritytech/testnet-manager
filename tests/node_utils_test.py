...
class NodeUtilsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.polkadot.with_command('--dev --validator --node-key 4b067400ba508d783ccf86b73aa825ebafea96c95ebdff3f307ab6dd854f0852 --unsafe-rpc-external --unsafe-rpc-external --rpc-methods=unsafe  --rpc-cors=all')
